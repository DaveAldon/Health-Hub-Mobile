...
interface PLXBackgroundInterface extends EventSubscriptionVendor {
   ...
   */
  scheduleBackgroundProcessing(taskName: string, timeout: number): Promise<string>;
 ...
 */
const startBackgroundTask = async (taskName: string, expiredCallback: (taskName: string) => void) => {
 ...
 */
const scheduleBackgroundProcessingTask = async (taskName: string, timeout: number, taskExecutionCallback: (taskName: string) => void, taskExpiredCallback: (taskName: string) => void) => {
 ...
 * @param result   True if task completed successfully
 */
const completeBackgroundProcessingTask = (taskName: string, result: boolean) => {
